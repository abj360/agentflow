...
Contains:
    ...
    (run: locust -f tests/load/soak.py --run-time 2h --users 200,
     see SOAK_DURATION_MINUTES and SOAK_TARGET_USERS)
"""
...
SOAK_ERROR_RATE_BUDGET = 0.001  # 0.1% of requests may fail before alerting
# 500-user variant lives in tests/load/locustfile.py
